    ...
    <section className="bg-gradient-to-top">
      <div className="m-auto flex max-w-[90rem] flex-col items-center px-24 py-32">
        <div className="mb-20 flex max-w-[51.625rem] flex-col items-center gap-y-6">
          ...
          <h2 className="text-primary-50 text-center text-6xl/18 font-semibold tracking-tighter">What our AI-powered <br />
        ...
        <button 
          className="text-primary-50 border-primary-50 transition-properties hover:bg-primary-50 hover:text-primary-1300 group cursor-pointer flex items-center gap-x-3 rounded-full border-2 px-8 py-3.5 text-lg/8"
