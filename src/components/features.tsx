  ...
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('/src/assets/Noise.webp')] bg-repeat">
      <div className="text-primary-50 relative m-auto max-w-[90rem] px-24 py-32 max-xl:px-16 max-xl:py-24">
        <div className="bg-primary-1300 absolute top-[50%] left-[100%] h-[62.5rem] w-[62.5rem] -translate-[50%] rounded-full opacity-100 blur-[40rem] max-xl:h-[35rem] max-xl:blur-[10rem] max-xl:w-[35rem]"/>
        ...
        <div className="grid grid-cols-2 items-center mb-20 gap-x-16 max-xl:mb-12">
          ...
          <div className="z-1 max-w-lg justify-self-end">
            <p className="mb-8 text-5xl/10 font-semibold tracking-tighter max-xl:mb-6 max-xl:text-4xl/10">Smart Organization</p>
        ...
        <div className="grid grid-cols-2 items-center gap-x-16">
          <div className="max-w-lg justify-self-start">
            <p className="mb-8 text-5xl/10 font-semibold tracking-tighter max-xl:mb-6 max-xl:text-4xl/10">Contextual Reminders</p>
            <p className="text-primary-100 z-1 text-xl/loose font-light max-xl:text-lg/8">
