      ...
      <div className="text-primary-50 relative m-auto max-w-[90rem] px-24 py-32">
        ...
        <div className="grid grid-cols-2 items-center mb-20 gap-x-16">
          ...
          <div className="z-1 max-w-lg justify-self-end">
            <p className="mb-8 text-5xl/10 font-semibold tracking-tighter">Smart Organization</p>
        ...
        <div className="grid grid-cols-2 items-center gap-x-16">
          <div className="max-w-lg justify-self-start">
            <p className="mb-8 text-5xl/10 font-semibold tracking-tighter">Contextual Reminders</p>
            <p className="text-primary-100 z-1 text-xl/loose font-light">
          ...
          <figure className="z-1">
            <img src={ContextualReminders} alt="Cotextual Reminders iphone graphic" className="max-h-[45rem]"  />
          </figure>
        </div>
      </div>
    </section>
