...
export const SignUpModal = () => {
  ...
  return (
    <section className="grid max-w-3xl grid-cols-2 max-sm:w-96 max-sm:grid-cols-1">
      ...
      <div className="bg-primary-1500 flex flex-col justify-between gap-y-24 bg-[url('src/assets/Noise.webp')] bg-repeat p-10 max-md:py-8 max-md:px-6 max-sm:gap-y-16">
        {/* Form */}
        <button 
        ...
        >
          <Close className="stroke-primary-75 group-hover:stroke-primary-1300 transition-properties max-md:h-4 max-md:w-4" width={2}/>
        </button>
        ...
        <div>
          <div onClick={() => setChecked((currVal)=> !currVal)} className="m-auto mb-4 w-fit cursor-pointer gap-x-2 max-sm:mb-3">
          ...
          <button onClick={handleSubmit} className="bg-primary-500 primary-glow-hover trasnition-properties w-full cursor-pointer rounded-full py-4 text-lg/8 max-md:px-6 max-md:py-3 max-md:text-base/loose">Get Started</button>
        </div>
      </div>
    </section>
  )
